  ...
  return (
    <ThemeProvider theme={theme} >
      <div style={{ margin: 'auto' }}>
        <p style={{ textAlign: 'center' }}>{newUser.username}</p>
        <p style={{ textAlign: 'center' }}>{newUser.firstName}</p>
        <p style={{ textAlign: 'center' }}>{newUser.lastName}</p>
        <p style={{ textAlign: 'center' }}>{newUser.email}</p>
